...
void GLIS_error_to_string(GLint err) {
    switch(err) {
        ...
        GLIS_ERROR_SWITCH_CASE(GL_NO_ERROR)
        GLIS_ERROR_SWITCH_CASE(GL_INVALID_ENUM)
        GLIS_ERROR_SWITCH_CASE(GL_INVALID_VALUE)
        GLIS_ERROR_SWITCH_CASE(GL_INVALID_OPERATION)
        GLIS_ERROR_SWITCH_CASE(GL_INVALID_FRAMEBUFFER_OPERATION)
        GLIS_ERROR_SWITCH_CASE(GL_OUT_OF_MEMORY)
