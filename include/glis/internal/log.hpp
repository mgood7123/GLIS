...
#define LOG_MAGNUM_FATAL Corrade::Utility::Fatal{&streamFatal, -1} << Corrade::Utility::Debug::color(Corrade::Utility::Debug::Color::Red)
#else
...
#define LOG_MAGNUM_FATAL Corrade::Utility::Fatal{-1} << Corrade::Utility::Debug::color(Corrade::Utility::Debug::Color::Red)
#endif
